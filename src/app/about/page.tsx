  ...
  return (
    <div className="w-full max-w-[800px] mx-auto px-5 lg:px-8 py-16 md:py-[120px]">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        <div className="w-48 h-48 md:w-64 md:h-64 flex-shrink-0 rounded-lg overflow-hidden border border-stone/50 p-1 mx-auto md:mx-0">
        ...
        <div className="prose-none font-sans text-lg text-ink/90 leading-[1.7] space-y-6">
          <p>
