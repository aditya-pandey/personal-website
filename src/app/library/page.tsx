    ...
    <div className="w-full max-w-[1120px] mx-auto px-5 lg:px-8 py-16 md:py-[120px]">
      ...
      <section>
        ...
        <div className="flex flex-col">
          {library.map((book) => (
            <Link key={book.slug} href={`/library/${book.slug}`} className="group flex flex-col md:flex-row md:items-center justify-between py-6 border-b border-stone/30 hover:bg-surface/30 px-4 -mx-4 transition-colors duration-300">
